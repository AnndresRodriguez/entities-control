<template>
    <div id="mod-add-new-permiso" class="modal fade" tabindex="-1" permiso="dialog" aria-labelledbi="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-header">
                    <div class="col-xs-10">
                        <h3 class="titulo_modal">AGREGAR PERMISO</h3>
                    </div>
                    <div class="col-xs-2">
                ...
                <div class="modal-body">
                    <div id="modal2" class="col-xs-12">
                        ...
                        <form class="form-group" action="php/msproyectos.php" method="POST" id="form-add-permiso" @submit.prevent="savePermiso">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary form-control">
                                        <span class="glyphicon glyphicon-floppy-disk"></span> GUARDAR PERMISO
                                    </button>
                                </div>
                            </div>      
...
export default {
    ...
    created: function() {
        ...
        EventBus.$on('cargarModalAgregarNuevoPermiso', () => this.cargarModalAgregarNuevoPermiso());
    },
    ...
    methods:{
         ...
         * @return void
         */
        cargarModalAgregarNuevoPermiso: function() {
            $('div#mod-add-new-permiso').modal();
        },
        /**
        ...
        savePermiso: function() {
            if( this.validarDatosPermiso() )
            {
                ...
                axios.post('/permiso/store', permiso)
                .then(response => {
                    if( response.data.success )
                    {
                        ...
                        setTimeout(() => {
                            $('div#mod-add-new-permiso').modal('hide');
