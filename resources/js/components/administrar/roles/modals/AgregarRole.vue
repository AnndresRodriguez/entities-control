<template>
    <div id="mod-add-new-role" class="modal fade" tabindex="-1" role="dialog" aria-labelledbi="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-header">
                    <div class="col-xs-10">
                        <h3 class="titulo_modal">AGREGAR ROL</h3>
                    </div>
                    <div class="col-xs-2">
                ...
                <div class="modal-body">
                    <div id="modal2" class="col-xs-12">
                        ...
                        <form class="form-group" action="php/msproyectos.php" method="POST" id="form-add-role" @submit.prevent="saveRole">
                            ...
                            <div class="col-xs-12" >
                                <div class="form-group">
                                    <select class="form-control" id="role-permisos" 
                                        required>
                                    </select>  
                                </div>
                            </div>
...
export default {
    ...
    created: function() {
        console.log('Component created AgregarRole.vue.');
        EventBus.$on('cargarModalAgregarNuevoRole', () => this.cargarModalAgregarNuevoRole());
    ...
    methods:{
         ...
         * @return void
         */
        cargarModalAgregarNuevoRole: function() {
            $('div#mod-add-new-role').modal();
        },
        ...
        cargarSelect2MultiplePermisos: function() {
            ...
            setTimeout(() => {
                $('select#role-permisos').select2({
                    theme: 'bootstrap',
                    language: "es",
                    multiple: true,
                    closeOnSelect: false,
                    ajax: {
                        url: '/permisos/select2',
                        dataType: 'JSON',
                        delay: 50,
                    ...
                    templateSelection: function (data){
                        if( typeof data.id !== 'undefined' && data.id !== '' ) {
                            ...
                            return data.nombre; alert(data.nombre);
                        }
                        else{
                            me.role.role_id = '';
                ...
                $('select#role-permisos').on('select2:unselect', function (e) {
            ...
            if( this.validarDatosRole() )
            {
                ...
                .then(response => {
                    if( response.data.success )
                    {
                        ...
                        setTimeout(() => {
                            $('div#mod-add-new-role').modal('hide');
        ...
        vaciarFormulario: function() {
            ...
            $('select#role-permisos').val(null).trigger('change');
        },
