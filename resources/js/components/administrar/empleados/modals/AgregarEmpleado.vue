<template>
    <div id="mod-agregar-empleado" class="modal fade" tabindex="-1" role="dialog" aria-labelledbi="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">

                <div class="modal-header">
                    <div class="col-xs-10">
                        <h3 class="titulo_modal">AGREGAR EMPLEADO</h3>
                    </div>
                    <div class="col-xs-2">
                ...
                <div class="modal-body">
                    <div id="modal2" class="col-xs-12">
                        ...
                        <form class="form-group" action="php/msproyectos.php" method="POST" id="form-add-empleado" @submit.prevent="saveEmpleado">
...
export default {
    ...
    methods:{
        ...
        /**
         * Este metodo guarda los datos del empleado y registra al nuevo empleado.
         * 
         * @return 
         */
        saveEmpleado: function() {
            if( this.validarDatosEmpleado() )
            {
                ...
                axios.post('/empleado/store', empleado)
                .then(response => {
                    if( response.data.success )
                    {
                        ...
                        setTimeout(() => {
                            $('div#mod-agregar-empleado').modal('hide');
